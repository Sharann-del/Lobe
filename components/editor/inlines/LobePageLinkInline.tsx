...
type PageLinkInlineProps = ReactCustomInlineContentRenderProps<
  {
    type: "pageLink";
    content: "none";
    propSchema: {
...
function LobePageLinkInlineView(props: PageLinkInlineProps): ReactElement {

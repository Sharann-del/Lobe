...
export interface SidePanelPrivateProps {
  collapsed?: boolean;
  className?: string;
}

/** Uses client-persisted `privateNodeIds` until a workspace visibility column exists. */
export function SidePanelPrivate({
  collapsed,
  className,
}: SidePanelPrivateProps) {

...
export function TableColumnHeader({
  ...
  const setSort = useGridViewStore((s) => s.setSort);
  const setColumnWidth = useGridViewStore((s) => s.setColumnWidth);
  const toggleColumnVisibility = useGridViewStore((s) => s.toggleColumnVisibility);
  const deleteSchema = useGridViewStore((s) => s.deleteSchema);
